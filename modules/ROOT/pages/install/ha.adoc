...
See xref:../reference/server_config.adoc#_critical_configuration_values[Server Configuration] for more information on which flags must be set identically on server nodes.
====
