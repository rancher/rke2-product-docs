...
CoreDNS is deployed with the https://github.com/kubernetes-incubator/cluster-proportional-autoscaler[autoscaler] by default. To disable it or change its config, use the xref:add-ons/helm.adoc#_customizing-packaged-components-with-helmchartconfig[HelmChartConfig] resource.
...
.ingress-nginx EOL
====
https://kubernetes.io/blog/2025/11/11/ingress-nginx-retirement/[ingress-nginx becomes EOL] in March 2026. RKE2 will still include ingress-nginx in v1.36 but with a deprecated status. No new images with fixes should be expected after March 2026. Please switch to Traefik or become a https://www.suse.com/products/rancher/[Rancher Prime user] for an extended support period.
====
