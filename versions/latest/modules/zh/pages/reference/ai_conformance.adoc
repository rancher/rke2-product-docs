...
This requirement mandates access to accelerators from within containers must be properly isolated and mediated by Kubernetes. To achieve this, install the NVIDIA GPU Operator as described in the GPU Operator documentation link:../add-ons/gpu_operators.md#deploy-nvidia-operator[docs].
