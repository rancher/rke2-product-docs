...
这是一个关于可以用于配置Windows RKE2代理的所有参数的参考。

[NOTE]
====
Windows支持要求选择Calico或Flannel作为RKE2集群的CNI。
====
...
[NOTE]
====
此 Windows 代理配置参考的最后一次更新是在 v1.22.5+rke2r2 版本。
...
== Windows RKE2代理Calico环境变量

Windows上的Calico安装可以使用环境变量进行自定义。您可以通过以下方式指定这些变量：
