...
The following two example plans will continuously keep your your cluster upgraded to the current stable release, by targeting the stable xref:upgrade/manual.adoc#_release_channels[release channel]:
