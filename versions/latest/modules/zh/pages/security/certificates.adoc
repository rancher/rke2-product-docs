...
If you want to generate new certificates and keys, instead of extending the validity of the existing certificates, use the <<otating Client and Server Certificates Manually,`rotate`>> subcommand documented below.
