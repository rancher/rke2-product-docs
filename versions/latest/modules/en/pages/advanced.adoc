...
The SLES repositories have the nvidia-open packages, which include the open gpu kernel drivers. If your GPU supports the open drivers, you can check that in this https://github.com/NVIDIA/open-gpu-kernel-modules#compatible-gpus[list], you can install the drivers by executing:
