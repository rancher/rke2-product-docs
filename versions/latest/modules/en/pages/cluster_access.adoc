= Cluster Access
:description: Configure access to the Kubernetes cluster using the kubeconfig file stored at /etc/rancher/rke2/rke2.yaml
...
[#_accessing_the_cluster_from_outside_with_kubectl]
