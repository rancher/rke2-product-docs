...
.Version Gate
====
The pre-importing of images while RKE2 is running feature is available as of January 2025 releases: v1.32.0+rke2r1, v1.31.5+rke2r1, v1.30.9+rke2r1, v1.30.13+rke2r1. Before that, RKE2 pre-imported the images only when booting.
====
