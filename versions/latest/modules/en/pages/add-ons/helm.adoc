= Helm
:description: Use Helm to manage Kubernetes deployments by creating configurable Helm charts with RKE2, which automatically deploys manifests
...
Find the full API in the https://github.com/k3s-io/helm-controller/blob/master/doc/helmchart.md#HelmChart[auto-generated API docs].
...
[#_automatically_deploying_manifests_and_helm_charts]
