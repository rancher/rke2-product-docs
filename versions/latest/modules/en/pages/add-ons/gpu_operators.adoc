...
* Install link:https://instinct.docs.amd.com/projects/gpu-operator/en/latest/installation/kubernetes-helm.html?utm_source=chatgpt.com#install-cert-manager[cert-manager].
