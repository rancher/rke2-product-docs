= GPU Operators
:description: Deploy, manage, and verify GPU resources in RKE2 clusters using NVIDIA and AMD operators by installing required drivers and checking host OS compatibility
