...
For more information, refer to https://github.com/rancher/rke2/blob/master/docs/adrs/011-bundle-gatewayAPI.md#standalone-gateway-api-crd-management[Standalone Gateway API CRD Management].
