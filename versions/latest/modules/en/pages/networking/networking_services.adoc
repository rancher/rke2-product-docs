...
Starting with v1.37, Traefik will stop managing Gateway API CRDs and RKE2 will bundle Gateway API  CRDs natively. For more information check this https://github.com/rancher/rke2/blob/master/docs/adrs/011-bundle-gatewayAPI.md#standalone-gateway-api-crd-management[document].
