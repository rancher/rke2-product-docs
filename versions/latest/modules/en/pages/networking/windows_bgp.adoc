= Windows and BGP
:description: Enable BGP on Calico for Windows nodes using RKE2 by selecting the Calico CNI, setting encapsulation to None, and enabling RemoteAccess
:page-languages: [en, de, es, fr, ja, pt, zh]
:revdate: 2025-10-29
:page-revdate: {revdate}

[#_enabling_bgp_on_calico_with_windows]
