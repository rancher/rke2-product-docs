= Network Options
:description: Choose a CNI plugin for Kubernetes networking, install it via Helm chart, customize with HelmChartConfig, and select from Canal, Calico, Flannel, or Cilium
...
spec:
  valuesContent: |-
    flannel:
      iface: "eth1"
----
To use flannel's https://github.com/flannel-io/flannel/blob/master/Documentation/backends.md#wireguard[wireguard backend] (https://www.wireguard.com/install/[Users of kernels < 5.6 need to install a module]) the following chart values must be used:
...
For more information on Calico's eBPF dataplane, refer to https://docs.tigera.io/calico/latest/operations/ebpf/[Calico's documentation].
======
...
For more information about values available in the Cilium chart, please refer to the https://github.com/rancher/rke2-charts/blob/main/charts/rke2-cilium/rke2-cilium/1.19.101/values.yaml[rke2-charts repository]. 
...
For more information about values available for the Calico chart, please refer to the https://github.com/rancher/rke2-charts/blob/main/charts/rke2-calico/rke2-calico/v3.31.400/values.yaml[rke2-charts repository].  
