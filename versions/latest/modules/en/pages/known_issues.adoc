...
:description: Avoid unexpected behavior by disabling firewalld, configuring NetworkManager to ignore calico/flannel interfaces, and applying calico helm chart settings
...
[#_firewalld_conflicts_with_default_networking]
...
[#_istio_in_selinux_enforcing_system_fails_by_default]
...
[#_calico_with_vxlan_encapsulation]
