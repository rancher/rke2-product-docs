...
:description: Configure the Windows RKE2 agent using parameters, set Calico environment variables, and customize settings via the CLI
...
[#_windows_rke2_agent_calico_env_variables]
