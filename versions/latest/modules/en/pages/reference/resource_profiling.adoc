= Resource Profiling
:description: Learn to determine minimum CPU and memory requirements for RKE2 server and agent components using test results
...
[#_rke2_cluster_with_a_single_agent]
