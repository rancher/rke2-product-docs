...
:description: Configure the rke2 server using parameters and critical values listed in this reference to ensure consistent cluster settings on all nodes
...
[#_critical_configuration_values]
...
| disable
| Do not deploy packaged components and delete any deployed components (valid items: rke2-coredns, rke2-metrics-server, rke2-snapshot-controller, rke2-snapshot-controller-crd, rke2-snapshot-validation-webhook, rke2-security-responder, rke2-gateway-api-crd)
| 
| 
