= High Availability
:description: Install a high availability RKE2 cluster with a fixed registration address, three server nodes and agent nodes
...
[#_1_configure_the_fixed_registration_address]
...
[#_2_launch_the_first_server_node]
...
[#_2a_optional_consider_server_node_taints]
...
[#_3_launch_additional_server_nodes]
...
[#_4_confirm_cluster_is_functional]
