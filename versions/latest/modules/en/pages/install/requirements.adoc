...
See the https://www.suse.com/suse-rke2/support-matrix/all-supported-versions/rke2-v1-36[RKE2 Support Matrix] for all the OS versions that have been validated with RKE2. In general, RKE2 should work on any Linux distribution that uses systemd and iptables/nftables.
...
[#_cni_specific_inbound_network_rules]
...
[#_windows_specific_inbound_network_rules]
