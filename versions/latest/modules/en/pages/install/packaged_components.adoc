...
:description: Managing packaged components lets you deploy, modify, and disable Kubernetes add-ons using manifests in the /var/lib/rancher/rke2/server/manifests directory
:page-languages: [en, de, es, fr, ja, pt, zh]
:revdate: 2025-08-06
:page-revdate: {revdate}

[#_auto_deploying_manifests_addons]
...
For information about managing Helm charts via auto-deploying manifests, refer to the section about xref:add-ons/helm.adoc[Helm].
