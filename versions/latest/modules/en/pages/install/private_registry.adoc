...
:description: Configure registries.yaml to set up private registry connections for containerd in RKE2 clusters and specify mirrors, authentication, and custom TLS settings
...
[#_registries_configuration_file_1]
