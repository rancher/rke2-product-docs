...
:description: Manage server roles by configuring RKE2 to enable or disable control-plane and etcd components on separate nodes
...
[#_dedicated_control_plane_nodes]
...
[#_adding_roles_to_existing_servers]
