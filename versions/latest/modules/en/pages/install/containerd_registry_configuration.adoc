...
:description: Learn how to configure Containerd to connect to private registries using the registries.yaml file to set up TLS or authentication
...
[#_registries_configuration_file]
