...
* Make sure your environment fulfills the xref:./requirements.adoc[requirements]. If NetworkManager is installed and enabled on your hosts, xref:../known_issues.adoc#_networkmanager[ensure that it is configured to ignore CNI-managed interfaces].
...
----
+
To learn more about the config.yaml file, refer to the xref:./configuration.adoc#_configuration-file[Configuration Options documentation].
