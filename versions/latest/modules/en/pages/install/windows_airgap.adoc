...
:description: Install Windows RKE2 on air-gapped nodes by preparing the agent, downloading required tarballs or private registry images, and configuring the agent
...
[#_prepare_the_windows_agent_node]
