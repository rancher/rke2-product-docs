...
Upgrades performed via the installation script or using our xref:upgrade/automated.adoc[automated upgrades] feature can be tied to different release channels. The following channels are available:
