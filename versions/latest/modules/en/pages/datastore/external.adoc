= External Datastore
:description: Configure an external datastore for Kubernetes using MySQL, PostgreSQL, or etcd with the datastore-endpoint parameter
...
[#_datastore_options_1]
== Datastore Options

* *External Database*
** https://etcd.io/[etcd] (certified against version 3.6.7)
** https://www.mysql.com[MySQL] (certified against versions 8.4.8)
** https://mariadb.org/[MariaDB] (certified against version 11.4.10)
** https://www.postgresql.org/[PostgreSQL] (certified against versions 18.3)
...
[#_1_create_an_external_datastore]
...
[#_3_optional_join_additional_server_nodes]
