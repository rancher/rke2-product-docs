= Embedded datastore
:description: Learn about using embedded etcd or SQLite as datastores in Kubernetes clusters to simplify deployment and improve performance and security
