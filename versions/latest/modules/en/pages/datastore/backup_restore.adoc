...
* https://dev.mysql.com/doc/refman/en/replication-snapshot-method.html[Official MySQL documentation]
* https://www.postgresql.org/docs/current/backup-dump.html[Official PostgreSQL documentation]
