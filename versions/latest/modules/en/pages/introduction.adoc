...
* Provides defaults and configuration options that allow clusters to pass the latest CIS Kubernetes Benchmarks with minimal operator intervention. (See xref:security/hardening_guide.adoc[CIS Hardening Guide] for the full list of supported benchmark versions.)
