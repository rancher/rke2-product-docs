...
:description: Learn the components and processes that make up a Next Generation Kubernetes Distribution, including RKE2's architecture, container runtime, cluster
...
image::rke2-overview.png[Architecture Overview]
