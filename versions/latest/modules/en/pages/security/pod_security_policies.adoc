...
.Version Gate
====
This document applies to RKE2 v1.24 and older, please refer to the xref:./pod_security_standards.adoc[Pod Security Standards Documentation] for the default policy information for RKE2 v1.25 and higher.
====
