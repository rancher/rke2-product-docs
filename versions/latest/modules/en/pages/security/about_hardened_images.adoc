...
:description: Learn how hardened images are built from source using a hardened base image, scanned for vulnerabilities, and use FIPS 140-3 compliant processes for Go binaries,
...
* Any binaries that are written in Go are compiled using a FIPS 140-3 compliant build process. For more information on this compiler, refer xref:security/fips3_support.adoc#_use_of_fips_compatible_go_compiler[here].
