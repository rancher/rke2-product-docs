= Windows-Agent-Konfigurations-Referenz
:page-languages: [en, zh]
:revdate: 2025-08-21
:page-revdate: {revdate}

Dies ist ein Verweis auf alle Parameter, die zur Konfiguration des Windows RKE2-Agenten verwendet werden können. 

[NOTE]
====
Der Windows-Support erfordert die Auswahl von Calico oder Flannel als CNI für den RKE2-Cluster.
====

== Windows RKE2 Agent Kommandozeilenschnittstellenhilfe
...
[NOTE]
====
Diese Windows-Agent-Konfigurations-Referenz wurde zuletzt mit der Version v1.22.5+rke2r2 aktualisiert.
...
== Windows RKE2 Agent Calico-Umgebungsvariablen

Die Installation von Calico auf Windows kann mit Umgebungsvariablen angepasst werden. Sie können diese Variablen wie folgt angeben:
...
Dies sind die aktuellen Variablen:
