= Référence de configuration de l'agent Windows
:page-languages: [en, zh]
:revdate: 2025-08-21
:page-revdate: {revdate}

Ceci est une référence pour tous les paramètres pouvant être utilisés pour configurer l'agent Windows RKE2. 
...
== Aide CLI de l'agent Windows RKE2
...
[NOTE]
====
Cette référence de configuration de l'agent Windows a été mise à jour pour la dernière fois avec la version v1.22.5+rke2r2.
...
== Variables d'environnement de Calico pour l'agent Windows RKE2

L'installation de Calico sur Windows peut être personnalisée à l'aide de variables d'environnement. Vous pouvez spécifier ces variables comme suit{nbsp}:
...
Voici les variables actuelles{nbsp}:
