= Windowsエージェント設定リファレンス
:page-languages: [en, zh]
:revdate: 2025-08-21
:page-revdate: {revdate}

これは、Windows RKE2エージェントを設定するために使用できるすべてのパラメータに関するリファレンスです。

[NOTE]
====
Windowsサポートでは、RKE2クラスターのCNIとしてCalicoまたはFlannelを選択する必要があります。
====

== Windows RKE2エージェントCLIヘルプ
...
[NOTE]
====
このWindowsエージェント設定リファレンスは、v1.22.5+rke2r2リリースを使用して最終更新されました。
...
== Windows RKE2エージェントのCalico環境変数

Windows上のCalicoインストールは、環境変数を使用してカスタマイズできます。これらの変数を指定するには、次のようにします：
