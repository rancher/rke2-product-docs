= Referencia de configuración del Agente de Windows
:page-languages: [en, zh]
:revdate: 2025-08-21
:page-revdate: {revdate}

Esta es una referencia a todos los parámetros que se pueden utilizar para configurar el agente RKE2 de Windows. 

[NOTE]
====
El soporte de Windows requiere elegir Calico o Flannel como el CNI para el clúster RKE2.
====

== Ayuda de la CLI del Agente RKE2 de Windows
...
[NOTE]
====
Esta referencia de configuración del Agente de Windows fue actualizada por última vez utilizando la versión v1.22.5+rke2r2.
...
== Variables de entorno de Calico del Agente RKE2 de Windows

La instalación de Calico en Windows se puede personalizar utilizando variables de entorno. Puedes especificar estas variables mediante:
...
Estas son las variables actuales:
