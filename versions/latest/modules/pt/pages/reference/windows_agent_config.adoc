= Referência de Configuração do Agente Windows
:page-languages: [en, zh]
:revdate: 2025-08-21
:page-revdate: {revdate}

Esta é uma referência a todos os parâmetros que podem ser usados para configurar o agente RKE2 do Windows. 

[NOTE]
====
O suporte ao Windows requer a escolha de Calico ou Flannel como CNI para o cluster RKE2.
====

== Ajuda do CLI do Agente RKE2 do Windows
...
[NOTE]
====
Esta Referência de Configuração do Agente Windows foi atualizada pela última vez com a versão v1.22.5+rke2r2.
...
== Variáveis de ambiente para o Calico no Agente Windows RKE2

A instalação do Calico no Windows pode ser personalizada usando variáveis de ambiente. Você pode especificar essas variáveis por:
