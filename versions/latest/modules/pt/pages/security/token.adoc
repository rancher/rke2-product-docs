...
Você não precisa usar este comando para gerar um token. Você pode fazer isso, desde que esteja no formato [6 alphanumeric characters].[16 alphanumeric characters], onde a primeira parte é o ID do token e a segunda parte é o segredo.
